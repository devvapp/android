...
import com.devvapp.play.sunshine.data.SunshinePreferences;
import com.devvapp.play.sunshine.utilities.NetworkUtils;
import com.devvapp.play.sunshine.utilities.OpenWeatherJsonUtils;
...
public class MainActivity extends AppCompatActivity implements ForecastAdapter.ForecastAdapterOnClickHandler, LoaderManager.LoaderCallbacks<String[]> {
    ...
    /**
     * Implement ForecastAdapterOnClickHandler onClick
     *
     * @param weatherForDay
     */
    @Override
